...
class AutoFixer:
    ...
    def __init__(self, repo_root: str = ".", dry_run: bool = True):
        ...
        self.safe_replacements = [
            ...
            (r'Berkeley SciComp Framework', 'SciComp'),
            (r'Berkeley-SciComp', 'SciComp'),
            (r'UC Berkeley SciComp Framework', 'SciComp'),
            
            # Old taglines -> correct tagline
            (r'Advanced Scientific Computing Platform for Quantum Physics', 
             'A Cross-Platform Scientific Computing Suite for Research and Education'),
            (r'Advancing the frontiers of magnetic computing through open science',
